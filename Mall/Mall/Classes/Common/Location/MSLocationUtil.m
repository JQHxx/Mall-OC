...
@implementation MSLocationUtil

static MSLocationUtil *_instance = nil;

+ (instancetype) sharedInstance {
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        _instance = [[MSLocationUtil alloc]init];
    });
    return _instance;
}
